...
func main() {
	var tempLst []float64 = []float64{-25.4, -27.0, 13.0, 19.0, 15.5, 24.5, -21.0, 32.5}

	tempMap := make(map[int][]float64)

	for _, temp := range tempLst {
		tempKey := int(temp/10) * 10
		tempMap[tempKey] = append(tempMap[tempKey], temp)
	}
